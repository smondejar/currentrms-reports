    ...
    public static function getAll(): array
    {
        return [
            'product_revenue' => [
                ...
                'description' => 'Shows revenue generated by each product with quote count and totals',
                'icon' => 'trending-up',
                'category' => 'Revenue',
                'module' => 'custom:product-utilisation',
                'columns' => ['name', 'product_group_name', 'rental_rate', 'times_quoted', 'total_revenue'],
                'filters' => [],
                'sorting' => ['field' => 'total_revenue', 'direction' => 'desc'],
            ],
            'product_catalog' => [
                'name' => 'Product Catalog',
                'description' => 'Shows all products with their rental and sale prices',
                'icon' => 'list',
                'category' => 'Products',
                'module' => 'products',
                'columns' => ['id', 'name', 'product_group_name', 'type', 'rental_rate', 'sale_price', 'replacement_charge'],
                'filters' => [],
                'sorting' => ['field' => 'name', 'direction' => 'asc'],
            ],
            'product_utilisation' => [
                'name' => 'Product Utilisation Report',
                'description' => 'Shows how many times each product has been quoted/added to opportunities with revenue totals',
                'icon' => 'bar-chart-2',
                'category' => 'Inventory',
                'module' => 'custom:product-utilisation',
                'columns' => ['name', 'product_group_name', 'type', 'rental_rate', 'times_quoted', 'total_quantity_quoted', 'total_revenue', 'opportunities_count'],
                'filters' => [],
                'sorting' => ['field' => 'times_quoted', 'direction' => 'desc'],
            ],
            'stock_overview' => [
                'name' => 'Stock Levels Overview',
                'description' => 'Shows current stock levels, availability, and booking rates for products',
                'icon' => 'layers',
                'category' => 'Inventory',
                'module' => 'stock_levels',
            ...
            'customer_revenue' => [
                ...
                'description' => 'Shows total revenue, order count, and average order value per customer from opportunities',
                'icon' => 'users',
                'category' => 'Revenue',
                'module' => 'custom:customer-revenue',
                'columns' => ['name', 'company', 'email', 'type', 'total_revenue', 'opportunities_count', 'invoices_count', 'average_order_value'],
                'filters' => [],
                'sorting' => ['field' => 'total_revenue', 'direction' => 'desc'],
            ],
            'monthly_revenue' => [
