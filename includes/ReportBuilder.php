        ...
        $this->modules = [
            'products' => [
                ...
                'filters' => [
                    ...
                    'product_group_name' => ['label' => 'Group', 'type' => 'dynamic', 'dynamic_field' => 'product_group_name', 'predicates' => ['eq', 'not_eq', 'cont']],
            ...
            'members' => [
                ...
                'filters' => [
                    ...
                    'address_city' => ['label' => 'City', 'type' => 'dynamic', 'dynamic_field' => 'address_city', 'predicates' => ['eq', 'cont']],
                    'address_country_name' => ['label' => 'Country', 'type' => 'dynamic', 'dynamic_field' => 'address_country_name', 'predicates' => ['eq']],
                    'created_at' => ['label' => 'Created Date', 'type' => 'date', 'predicates' => ['eq', 'lt', 'gt', 'lteq', 'gteq']],
                ],
            ],
            'opportunities' => [
                ...
                'filters' => [
                    ...
                    'member_name' => ['label' => 'Customer', 'type' => 'dynamic', 'dynamic_field' => 'member_name', 'predicates' => ['eq', 'cont']],
                    'owner_name' => ['label' => 'Owner', 'type' => 'dynamic', 'dynamic_field' => 'owner_name', 'predicates' => ['eq']],
                    ...
                    'venue_name' => ['label' => 'Venue', 'type' => 'dynamic', 'dynamic_field' => 'venue_name', 'predicates' => ['eq', 'cont']],
                    'venue_city' => ['label' => 'Venue City', 'type' => 'dynamic', 'dynamic_field' => 'venue_city', 'predicates' => ['eq', 'cont']],
                    'project_name' => ['label' => 'Project', 'type' => 'dynamic', 'dynamic_field' => 'project_name', 'predicates' => ['eq', 'cont']],
                    'created_at' => ['label' => 'Created Date', 'type' => 'date', 'predicates' => ['eq', 'lt', 'gt', 'lteq', 'gteq']],
                    'updated_at' => ['label' => 'Updated Date', 'type' => 'date', 'predicates' => ['eq', 'lt', 'gt', 'lteq', 'gteq']],
                ],
            ],
            ...
            'projects' => [
                ...
                'filters' => [
                    ...
                    'member_name' => ['label' => 'Client', 'type' => 'dynamic', 'dynamic_field' => 'member_name', 'predicates' => ['eq', 'cont']],
                    'owner_name' => ['label' => 'Owner', 'type' => 'dynamic', 'dynamic_field' => 'owner_name', 'predicates' => ['eq']],
                    'status' => ['label' => 'Status', 'type' => 'select', 'options' => ['Active', 'Completed', 'On Hold', 'Cancelled'], 'predicates' => ['eq', 'not_eq']],
                    'category' => ['label' => 'Category', 'type' => 'dynamic', 'dynamic_field' => 'category', 'predicates' => ['eq', 'cont']],
                    'starts_at' => ['label' => 'Start Date', 'type' => 'date', 'predicates' => ['eq', 'lt', 'gt', 'lteq', 'gteq']],
                    'ends_at' => ['label' => 'End Date', 'type' => 'date', 'predicates' => ['eq', 'lt', 'gt', 'lteq', 'gteq']],
            ...
            'stock_levels' => [
                ...
                'filters' => [
                    ...
                    'store_name' => ['label' => 'Store', 'type' => 'dynamic', 'dynamic_field' => 'store_name', 'predicates' => ['eq']],
